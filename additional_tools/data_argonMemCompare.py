...
data2 = pd.read_csv("16384_2x_2048_1_1.csv")
# Create DataFrame
...
# Plot the data
plt.plot(batch_size, hash_rate_khs, color='#2ca25f', label='Argon2D Memory Cost = 10240KiB')
#plt.plot(batch_size2, hash_rate_khs2, color='#99d8c9', label='Sha256')
plt.plot(batch_size2, hash_rate_khs2, color='#99d8c9', label='Argon2D Memory Cost = 2048KiB')
...
# Add a title
plt.title('Argon2 Memory Cost Comparison',fontsize=16)
